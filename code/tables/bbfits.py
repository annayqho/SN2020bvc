...
for ii in np.arange(n):
    ...
    ulstr = str(np.round(dat[:,root+1][ii]/scale,1))
    llstr = str(np.round(dat[:,root+2][ii]/scale,1))
    scale = 1E3
    root = 4
    tstr = str(np.round(dat[:,root][ii]/scale,1))
    utstr = str(np.round(dat[:,root+1][ii]/scale,1))
    ltstr = str(np.round(dat[:,root+2][ii]/scale,1))
    scale = 1E14
    root = 7
    rstr = str(np.round(dat[:,root][ii]/scale,1))
    urstr = str(np.round(dat[:,root+1][ii]/scale,1))
    lrstr = str(np.round(dat[:,root+2][ii]/scale,1))
